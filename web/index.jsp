...
<html>
    ...
    .bgimg-1 {
        background-image: url("imagem/justice3.jpeg");
        min-height: 100%;
    }
    ...
    <div class="w3-top">
      <div class="w3-bar" id="myNavbar">
        ...
        <a href="#portfolio" class="w3-bar-item w3-button"> PRATELEIRA VIRTUAL</a>
    ...
    <div class="w3-content w3-container w3-padding-64" id="portfolio">
      ...
      <div class="w3-row-padding w3-center">
        <div class="w3-col m3">
            <img src="imagem/spidermanvintage.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Amazing Spider Man">
        </div>

        <div class="w3-col m3">
            <img src="imagem/starwarsseries.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Star Wars">

        </div>

        <div class="w3-col m3">
            <img src="imagem/hulk2.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Hulk">
        </div>

        <div class="w3-col m3">
            <img src="imagem/deadpool2.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Deadpool">
        </div>
      </div>
