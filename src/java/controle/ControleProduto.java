    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(acao.equals("Cadastrar")){
                ...
                RequestDispatcher rd = request.getRequestDispatcher("/admin/ListaProd.jsp");
                ...
                if(acao.equals("Listar")){
                    ...
                    request.getRequestDispatcher("/admin/ListaProd.jsp").forward(request, response);
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/admin/AlterarProd.jsp");
                    //quem vai acionar toda essa ação é o forward
                    rd.forward(request, response);
                   ...
                   /* PrintWriter out = response.getWriter();
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("/admin/excluir.jsp");
                    rd.forward(request, response);
